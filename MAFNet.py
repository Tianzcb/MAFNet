...
class Net(nn.Module):
    ...
    def encoder(self, NC, ART, PV):
        ...
        m0 = NC.mul(atten_NC) + ART.mul(atten_ART) + PV.mul(atten_PV)
        ...
        m1 = m + NC.mul(atten_NC) + ART.mul(atten_ART) + PV.mul(atten_PV)
        ...
        m2 = m + NC.mul(atten_NC) + ART.mul(atten_ART) + PV.mul(atten_PV)
        ...
        m3 = m + NC.mul(atten_NC) + ART.mul(atten_ART) + PV.mul(atten_PV)
        ...
        m4 = m + NC.mul(atten_NC) + ART.mul(atten_ART) + PV.mul(atten_PV)
